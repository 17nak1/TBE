...
create_pomp_model <- function(data, covars, t0, 
  ...
  trans1 <- c("p","omega","delta",
              ...
              "beta_nh","gamma","tau",
              "lambda_l","lambda_n","lambda_a","alpha", "Tf","c","T_min_l","kappa",
              paste0(statenames[1:11],"0"))
  print(trans1)
  trans2 <- c("f_l","f_n","f_a","obsprob")
  ...
  TBE <- pomp(
    ...
    paramnames = c("p","omega","delta",
                   ...
                   "tau", 
                   "lambda_l","lambda_n","lambda_a","alpha","f_l","f_n","f_a","kappa", "c","Tf","T_min_l","obsprob",
                   paste0(statenames,"0")),
    dmeasure = dObs,
    rmeasure = rObs,
